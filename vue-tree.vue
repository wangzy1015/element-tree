      ...
      onPopperVisibleChange(isVisible) {
        if (isVisible) {
          this.$nextTick(() => {
            ...
            this.dropdownTree.$on("check-change", (data, node,a) => {
              // this.dropdownTree.setCheckedNodes(this.selectedValue);
              // this.dropdownTree.setCheckedNodes(data)
              // console.log(data,1 ,node,2,a)
            });
